package xyz.thishome.recruit.controller;
...
import xyz.thishome.recruit.pojo.Enterprise;
import xyz.thishome.recruit.service.EnterpriseService;
...
public class EnterpriseController {
    ...
    public Result findHotList(){
        List<Enterprise> ishot = enterpriseService.getIshot("1");
        return new Result(true,StatusCode.OK,"查询热门商品",ishot);
    }
